package com.learning.service.moviecatalog.swagger;
...
public class SwaggerConfig {
    ...
    public Docket eDesignApi(SwaggerConfigProperties swaggerConfigProperties) {
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo(swaggerConfigProperties))
        		.enable(Boolean.valueOf(swaggerConfigProperties.getEnabled())).select().apis(RequestHandlerSelectors.basePackage("com.learning"))
